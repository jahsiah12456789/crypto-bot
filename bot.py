...
def rsi(series, n=12):  # slightly faster
    delta = series.diff()
...
while True:
    try:
        ...
        if trend_up and rsi_val > 50:
            ...
            strength = "STRONG" if rsi_val > 55 else "NORMAL"
            ...
            tp2 = price - atr_val * 2.2
            sl = price + atr_val * 1.0
            strength = "STRONG" if rsi_val < 45 else "NORMAL"
